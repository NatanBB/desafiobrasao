export const NotFound = () => {
  return (
    <div className="min-h-full h-screen flex items-center justify-center py-12 px-6 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 flex justify-center">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            >
              Sorry, we can't find that page. You'll find lots to explore on the fields page.
            </p>
            <a
              href="/"
              className="inline-flex text-white bg-primary-600 border border-gray-700 hover:bg-gray-900 font-medium rounded-md text-sm px-5 py-2 text-center my-4"
            >
              Go Back
            </a>
          </div>
